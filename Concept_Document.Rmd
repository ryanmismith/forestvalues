...
I know this is an unconventional final report, but you had indicated that we can work on something that is part of a project or existing workflow. I have taken this opportunity to flesh out this package for use in the future. While it is still a bit bare bones now, it provides a framework for more complex analysis in the future.
